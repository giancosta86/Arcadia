...
export const hardwiredCompositions: readonly Composition[] = [
  ...
  { id: "la-gilda", title: "La gilda", date: new Date("2018-10-10") },
  {
    id: "sole-gentile",
  ...
  { id: "il-capitano", title: "Il capitano", date: new Date("2017-05-10") },
  {
    id: "ode-primavera",
  ...
  { id: "briscola", title: "Briscola", date: new Date("2014-05-18") },
  {
    id: "cavalier-aurora",
    title: "Il cavalier dell'aurora",
    date: new Date("2014-04-29")
  },
  { id: "il-mare", title: "Il mare", date: new Date("2014-04-24") },
  {
    id: "augel-cristallo",
    title: "L'augel di cristallo",
    date: new Date("2014-04-13")
  },
  { id: "les-fleurs", title: "Les fleurs", date: new Date("2014-03-10") },
  { id: "mezzanotte", title: "Mezzanotte", date: new Date("2014-02-15") },
  { id: "la-lune", title: "La lune", date: new Date("2013-12-15") },
  {
    id: "arc-en-ciel",
    title: "L'arc-en-ciel",
    date: new Date("2013-11-21")
  },
  { id: "le-nuvole", title: "Le nuvole", date: new Date("2013-10-14") },
  { id: "i-gemelli", title: "I gemelli", date: new Date("2013-09-14") },
  { id: "la-rondine", title: "La rondine", date: new Date("2013-08-18") },
  { id: "nel-vespro", title: "Nel vespro", date: new Date("2013-06-15") },
  {
    id: "due-scoiattoli",
